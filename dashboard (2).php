...
<body>
  ...
  <div class="container">
    <div class="welcome">Welcome back, Freelancer!</div>
    ...
    <div class="dashboard-grid">
      ...
      <!-- Entire Card Clickable for Post a Service -->
      <a href="postservice.php" class="card-link">
        <div class="card">
      ...
      <!-- Entire Card Clickable for Edit Profile -->
      <a href="editprofile.php" class="card-link">
        <div class="card">
